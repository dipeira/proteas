...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    if ($_GET['op'] == 'edit') {
        ...
        <div class="yph-card p-6 md:p-8 max-w-2xl mx-auto">
            <h2 class="text-xl font-bold text-slate-800 mb-2">Επεξεργασία Υπηρέτησης (MySchool)</h2>
            <p class="text-slate-500 text-sm mb-6">
                Εκπαιδευτικός: <strong><?php echo htmlspecialchars($employee['surname'] . ' ' . $employee['name']); ?></strong> (ΑΦΜ: <?php echo htmlspecialchars($employee['afm']); ?>)
            </p>
            ...
            <form method="POST" action="yphrethseis.php" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="sxesh" value="<?php echo htmlspecialchars($record['sxesh']); ?>" class="w-full px-3 py-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500" />
                </div>
                
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-1">Σχέση Τοποθέτησης</label>
                    <input type="text" name="sxesh_topo" value="<?php echo htmlspecialchars($record['sxesh_topo']); ?>" class="w-full px-3 py-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500" />
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="hours" value="<?php echo htmlspecialchars($record['hours']); ?>" class="w-full px-3 py-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500" min="0" required />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="sxol_etos" value="<?php echo htmlspecialchars($record['sxol_etos']); ?>" class="w-full px-3 py-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500" required />
                    </div>
                </div>
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                ?>
                <a href="<?php echo $back_url; ?>" class="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-800">
        ...
        <div class="yph-card p-6 md:p-8 mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-100 pb-4 mb-6">
                ...
                <div class="mt-4 md:mt-0 text-slate-500 text-sm border-t md:border-t-0 md:border-l border-slate-200 pt-4 md:pt-0 md:pl-6">
                    ...
                    <div>ΑΦΜ: <strong class="text-slate-800"><?php echo htmlspecialchars($employee['afm']); ?></strong></div>
            ...
            <?php if (empty($records_by_year)): ?>
                <div class="p-8 text-center bg-slate-50 rounded border border-dashed border-slate-300">
                    <p class="text-slate-600 font-medium">Δεν βρέθηκαν υπηρετήσεις από το σύστημα MySchool για τον συγκεκριμένο εκπαιδευτικό.</p>
                </div>
            <?php else: ?>
                <!-- Tabs Navigation -->
                <div class="flex border-b border-slate-200 mb-6 overflow-x-auto">
                    ...
                    foreach ($records_by_year as $year => $rows): 
                        ...
                        $first = false;
                    ?>
                        <button class="tab-button <?php echo $active_class; ?>" onclick="openYearTab(event, 'year-<?php echo $year; ?>')">
                        ...
                        <div id="year-<?php echo $year; ?>" class="tab-panel <?php echo $active_class; ?>">
                            <div class="overflow-x-auto border border-slate-200 rounded-lg">
                                <table class="min-w-full divide-y divide-slate-200 yph-table">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="text-left text-xs font-semibold text-white uppercase tracking-wider">Σχολείο</th>
                                            <th scope="col" class="text-left text-xs font-semibold text-white uppercase tracking-wider">Σχέση Εργασίας</th>
                                            <th scope="col" class="text-left text-xs font-semibold text-white uppercase tracking-wider">Σχέση Τοποθέτησης</th>
                                            <th scope="col" class="text-left text-xs font-semibold text-white uppercase tracking-wider">Ημ. Έναρξης</th>
                                            <th scope="col" class="text-left text-xs font-semibold text-white uppercase tracking-wider">Ημ. Λήξης</th>
                                            <th scope="col" class="text-center text-xs font-semibold text-white uppercase tracking-wider">Ώρες</th>
                                            <th scope="col" class="text-center text-xs font-semibold text-white uppercase tracking-wider">Κατάσταση</th>
                                            <?php if ($usrlvl < 3): ?>
                                                <th scope="col" class="text-center text-xs font-semibold text-white uppercase tracking-wider w-24">Ενέργειες</th>
                                            <?php endif; ?>
                                        </tr>
                                    </thead>
                                        ...
                                        ?>
                                            <tr class="hover:bg-slate-50/80 transition-colors">
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                    ...
                                                    ?>
                                                        <span class="inline-block px-2.5 py-1 text-xs font-semibold rounded-full border <?php echo $badge_color; ?>">
                                                ...
                                                <?php if ($usrlvl < 3): ?>
                                                    <td class="px-6 py-4 text-center whitespace-nowrap">
                                                        <div class="flex items-center justify-center space-x-2">
                                                            ...
                                                            <span title="Διαγραφή">
                                                                <a href="javascript:confirmDelete('yphrethseis.php?op=delete&id=<?php echo $row['id']; ?>')" class="hover:opacity-80 transition">
                                                                    <img style="border: 0pt none;" src="../images/delete_action.png" alt="Διαγραφή" />
                                                                </a>
                                                            </span>
                                                        </div>
                                                    </td>
