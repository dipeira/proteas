...
$proyp_misth = $_POST['pyears_misth']*360 + $_POST['pmonths_misth']*30 + $_POST['pdays_misth'];
$proyp_vathm = $_POST['pyears_vathm']*360 + $_POST['pmonths_vathm']*30 + $_POST['pdays_vathm'];
...
if (isset($_POST['action']))
{
    ...
    {
        $query0 = "INSERT INTO employee (name, surname, patrwnymo, mhtrwnymo, klados, am, sx_organikhs, sx_yphrethshs, fek_dior, hm_dior, vathm, mk, hm_anal, met_did, proyp, comments, afm, thesi, ent_ty, status, wres, proyp_not, proyp_wrario, proyp_misth, proyp_vathm) ";
        $query1 = "VALUES ('$name','$surname','$patrwnymo','$mhtrwnymo','$klados','$am','$org','$yphr_arr[0]','$fek_dior','$hm_dior','$vathm','$mk','$hm_anal','$met_did','$proyp','$comments', '$afm', '$thesi', '$entty', '$katast', '$wres', '$proyp_not', '$proyp_wrario', '$proyp_misth', '$proyp_vathm')";
        $query = $query0.$query1;
...
// if update
    ...
    $query4 = " hm_anal='$hm_anal', met_did='$met_did', proyp='$proyp', proyp_not='$proyp_not', proyp_wrario='$proyp_wrario', proyp_misth='$proyp_misth', proyp_vathm='$proyp_vathm', comments='$comments',afm='$afm', status='$katast', thesi='$thesi', ent_ty='$entty', wres='$wres',email='$email',email_psd='$email_psd',org_ent=$org_ent WHERE id='$id'";
