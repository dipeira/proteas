...
<?php        
        ...
        $root_path = '../';
        $page_title = 'Αποφάσεις αδειών';
        require_once '../etc/head.php'; 
        ...
        if (isset($_POST['btnSubmit']))
        {
            ...
            echo "<a href=\"$output1\" class='inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white font-medium rounded-lg shadow-lg hover:from-emerald-700 hover:to-emerald-600 hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500'>";
            echo "<svg class='w-5 h-5 mr-2' fill='none' stroke='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'></path></svg>";
            echo "Άνοιγμα εγγράφου";
            echo "</a>";
            echo "</div>";
