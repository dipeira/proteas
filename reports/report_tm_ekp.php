...
<?php
    ...
    if ($_POST['type']){
        ...
        if (in_array($_POST['type'],$dim_ar))
        {
            ...
            $num = mysql_num_rows($result);
                ...
                {		
                        ...
                        echo "<td>".$ekp_ar['ΠΕ70']."</td><td>".$ekp_ar['ΠΕ06']."</td><td>".$ekp_ar['ΠΕ11']."</td><td>".$ekp_ar['ΠΕ16']."</td>";
        ...
        //}	
                ...
                echo "<td>Τμ.Α'</td><td>Τμ.Β'</td><td>Τμ.Γ'</td><td>Τμ.Δ'</td><td>Τμ.Ε'</td><td>Τμ.ΣΤ'</td><td>Σύν.Τμ.</td><td>ΠΕ70</td><td>ΠΕ06</td><td>ΠΕ11</td><td>ΠΕ16</td><td>Τμ. Ολ.</td><td>Μαθ. Ολ.</td>";//<td>Εκπ. T.E.</td><td>Εκπ. T.Y.</td>";
                echo "</tr>";
                echo "</tbody></table>";
