...
if ($curpg!=1) {
    echo "<a href='index.php?page=1$getstring'>⏮️ Πρώτη</a>";
    echo "<a href='index.php?page=$prevpg$getstring'>◀️ Προηγούμενη</a>";
}
else {
...
if ($curpg != $lastpg) {
    $nextpg = $curpg+1;
    echo "<a href='index.php?page=$nextpg$getstring'>Επόμενη ▶️</a>";
    echo "<a href='index.php?page=$lastpg$getstring'>Τελευταία ⏭️</a>";
}
else { 
