    ...
    switch ($type)
        {
            case 1:
                ...
                break;
            case 2:
                $word->Documents->Open(realpath("word/kan.doc"));
                break;
            case 3:
                $word->Documents->Open(realpath("word/anar_gnwm.doc"));
                break;
            case 4:
                $word->Documents->Open(realpath("word/eidikh.doc"));
                break;
            case 5:
                $word->Documents->Open(realpath("word/loxeias.doc"));
                break;
            case 6:
                $word->Documents->Open(realpath("word/kyhshs.doc"));
                break;
            case 7:
                $word->Documents->Open(realpath("word/anatr.doc"));
                break;
            case 8:
                $word->Documents->Open(realpath("word/gonikh.doc"));
                break;
            case 9:
                $word->Documents->Open(realpath("word/kan_kyof.doc"));
                break;
            case 10:
                $word->Documents->Open(realpath("word/aney_1m.doc"));
                break;
            case 12:
                $word->Documents->Open(realpath("word/aney_1y.doc"));
                break;
            // loipes
        }
