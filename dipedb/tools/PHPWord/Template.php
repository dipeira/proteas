...
/*
    public function setValue($search, $replace) {
       ...
       //     $replace = mb_convert_encoding($replace, "iso-8859-7", "utf-8");
       // }
...
public function setValue2($search, $replace, $limit=-1) {
		...
		if ($numberOfClones > 0) {
			...
			foreach ($data as $colName => $dataArr) {
				...
				foreach ($dataArr as $value) {
					$this->setValue2($pattern, $value, 1);
				}
			}
		}
	}
