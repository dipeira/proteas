  ...
  <body> 
    <center>
      <?php
		...
		echo "</tbody>";
                if ($usrlvl < 2)
                    echo "<tr><td colspan=8><span title=\"Προσθήκη Άδειας\"><a href=\"adeia.php?emp=$emp_id&op=add\">Προσθήκη Άδειας<img style=\"border: 0pt none;\" src=\"images/user_add.png\"/></a></span>";		
                echo "</table>";
