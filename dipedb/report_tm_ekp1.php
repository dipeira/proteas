        ...
        if (in_array($_POST['type'],$dim_ar))
        {
            ...
            $num = mysql_num_rows($result);
                ...
                {		
                        ...
                        echo "<tr>";
                        echo "<td><a href='school_status.php?org=$sch'>$name</a></td><td>$code</td><td>$eaep</td><td>$organikothta</td><td>$leitoyrg</td><td>$classes[0]</td><td>$classes[1]</td><td>$classes[2]</td><td>$classes[3]</td><td>$classes[4]</td><td>$classes[5]</td><td>$synolo</td>\n";
