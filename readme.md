...
- Εγκατάσταση σε φάκελο του web server
- Δημιουργία νέας βάσης δεδομένων MySQL και εισαγωγή βασικών στοιχείων από το αρχείο dipedb.sql
- Δημιουργία του config.php (με βάση το config-sample.php) και εισαγωγή των στοιχείων της βάσης
- Εισαγωγή στοιχείων υπαλλήλων & σχολείων μέσω του phpmyadmin (θα αλλάξει σύντομα)
