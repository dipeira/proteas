...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `hm_dior` date NULL,
  `vathm_old` varchar(4) NULL,
  `vathm` varchar(4) NULL,
  `hm_vathm` date NULL,
  `mk_old` tinyint(2) NULL,
  `mk` tinyint(2) NULL,
  `hm_mk` date NULL,
  `mk11` tinyint(4) NULL,
  `hm_mk11` date NULL,
  ...
  `hm_anal` date NULL,
  `met_did` tinyint(11) NULL COMMENT '0 οχι, 1 μεταπτ, 2 διδ, 3 μετ+διδ',
  `proyp_old` int(11) NULL COMMENT 'se hmeres',
  ...
  `anatr_katataksi` int(11) NULL COMMENT 'se hmeres',
  `anatr` int(11) NULL COMMENT 'se hmeres',
  `anatr_excel` int(11) NULL COMMENT 'se hmeres',
  `comments` longtext NULL,
...
CREATE TABLE IF NOT EXISTS `employee_deleted` (
  ...
  `thesi` tinyint(4) NOT NULL COMMENT '0 εκπαιδευτικός, 1 υποδιευθυντης, 2 δ/ντής-πρ/νος, 3 Τμ.Ένταξης, 4 Διοικητικός, 5 Ιδιωτικός, 6Δ/ντής-Πρ/νος Ιδιωτικού Σχ., 7 Τάξη Υποδοχής',
