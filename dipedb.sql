...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `thesi` tinyint(4) NOT NULL COMMENT '0 εκπαιδευτικός, 1 υποδιευθυντης, 2 δ/ντής-πρ/νος, 3 Τμ.Ένταξης, 4 Διοικητικός, 5 Ιδιωτικός, 6 Δ/ντής-Πρ/νος Ιδιωτικού Σχ., 7 Τάξη Υποδοχής',
